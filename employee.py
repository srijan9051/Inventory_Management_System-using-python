...
class employeeClass:
    def __init__(self,root):
        ...
        self.root.title("Super Mart Inventory | Employee/Admin")
        ...
        #============options=========#
        cmb_search=ttk.Combobox(searchFrame,textvariable=self.var_searchby,values=("Select","Emp Id","Name","Contact"),state='readonly',justify=CENTER,font=("goudy old style",15))
        ...
        #===============Button============#
        btn_add=Button(self.root,text="Save",font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2",command=self.add).place(x=500,y=305,width=110,height=28)
        ...
        self.EmployeeTable.column("eid",width=75)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                messagebox.showerror("Error","Employee Id is missing",parent=self.root)
            else:
