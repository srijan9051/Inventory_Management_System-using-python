...
class supplierClass:
    def __init__(self,root):
        ...
        self.root.title("Super Mart Inventory | Supplier")
        ...
        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=965,y=79,width=100,height=28)
        ...
        #===============Button============#
        btn_add=Button(self.root,text="Save",font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2",command=self.add).place(x=180,y=370,width=110,height=35)
        ...
        sup_frame.place(x=700,y=120,width=400,height=350)
        ...
        self.supplierTable.column("invoice",width=75)
    ...
    def search(self):
        ...
        try:
            if self.var_searchtxt.get()=="":
                messagebox.showerror("Error","Invoice No. should not be empty",parent=self.root)
            else:
