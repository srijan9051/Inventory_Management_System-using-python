...
class salesClass:
    def __init__(self,root):
        ...
        self.root.title("Super Mart Inventory | Sales")
        ...
        btn_clear=Button(self.root,text="Clear",font=("times new roman",15,"bold"),bg="light grey",fg="black",cursor="hand2",command=self.clear).place(x=490,y=100,width=120,height=28)
